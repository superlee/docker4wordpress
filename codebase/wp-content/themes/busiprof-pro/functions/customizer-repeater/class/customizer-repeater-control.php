				...
				<div class="customizer-repeater-general-control-repeater-container customizer-repeater-draggable">
					...
					<div class="customizer-repeater-box-content-hidden">
						...
						if($this->customizer_repeater_button_text_control){
							...
							'busiprof'), $this->id, 'customizer_repeater_button_text_control'),
							'class' => 'customizer-repeater-button-text-control',
							'type' => apply_filters('busiprof_repeater_input_types_filter', '' , $this->id,
						...
						if($this->customizer_repeater_video_url_control){
							...
							'busiprof'), $this->id, 'customizer_repeater_video_url_control'),
...
//print_r($options);
	...
	<span class="customize-control-title">
	<?php esc_html_e('Slide Format','busiprof'); ?>
	</span>
