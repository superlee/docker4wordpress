...
function busiprof_slider_register_strings() {
	busiprof_pll_string_register_helper( 'busiprof_slider_content', 'Slider section' );
}
...
if ( function_exists( 'pll_register_string' ) ) {
	...
	add_action( 'after_setup_theme', 'busiprof_slider_register_strings', 11 );
}