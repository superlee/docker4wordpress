...
register_sidebar( array(
	'name' => __( 'WooCommerce sidebar widget area', 'busiprof' ),
	'id' => 'woocommerce-1',
...
//Header sidebar
	register_sidebar( array(
		'name' => __( 'Top header left area', 'busiprof' ),
		'id' => 'home-header-sidebar_left',
		'description' => __('Top header left area', 'busiprof' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => '</aside>',
		'before_title' => '<h3 class="widget-title">',
		'after_title' => '</h3>'
	...
	register_sidebar( array(
		'name' => __( 'Top header right area', 'busiprof' ),
		'id' => 'home-header-sidebar_right',
		'description' => __( 'Top header right area', 'busiprof' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => '</aside>',
		'before_title' => '<h3 class="widget-title">',
		'after_title' => '</h3>'
