			...
			<div class="row">
				<div class="col-md-12">
					<div class="section-title">
						...
						<h1 class="section-heading"><?php echo $current_options['testimonial_head'];?></h1>
...
<div class="carousel slide" data-ride="carousel" data-type="multi" data-interval="<?php echo $current_options['testimonial_speed']; ?>" id="myTestimonial">
