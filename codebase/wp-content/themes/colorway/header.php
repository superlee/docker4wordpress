...
<html <?php language_attributes(); ?>>
    ...
    <body 
        ...
        if (colorway_get_option('inkthemes_bodybg') != '') {
            echo esc_attr(colorway_get_option('inkthemes_bodybg'));
        }
            ...
            ?>">
                ...
                <div class="row header">
                    <div class="header_con">
                        ...
                        ?>">
                                 <?php if (colorway_get_option('colorway_logo') != '') { ?>
                                     <?php if (colorway_get_option('logo_option') != '') { ?>
                                    <a class="colorway_logo" href="<?php echo esc_url(home_url()); ?>"><img style="width:<?php
                                        ...
                                        ?>; height:auto;" src="<?php echo esc_url(colorway_get_option('colorway_logo')); ?>" alt="<?php wp_kses_post(bloginfo('name')); ?>"/></a>                              
                                                                                                        <?php } ?>
                                                                                                    <?php } ?>

                            <!--sticky header logo-->
                            <?php if (colorway_get_option('colorway_sticky_header') != '') { ?>
                                <?php if (colorway_get_option('sticky_logo_setting') != '') { ?>
                                <a class="colorway_logo_sticky sticky_logo_setting" href="<?php echo esc_url(home_url()); ?>"><img style="width:<?php
                                    ...
                                    ?>; height:auto;" src="<?php echo esc_url(colorway_get_option('sticky_logo_setting')); ?>" alt="<?php wp_kses_post(bloginfo('name')); ?>"/></a>                              
                                <?php }} ?>
                            <hgroup>   
                ...
                <?php if (colorway_get_option('border_bottom_on_off', 'on') != 'off') { ?>
