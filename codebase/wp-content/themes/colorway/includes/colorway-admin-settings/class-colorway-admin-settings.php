...
//            wp_localize_script('colorway-admin-settings', 'colorway', apply_filters('colorway_theme_js_localize', $localize));
        ...
        static public function colorway_welcome_page_sites_section() {
            ...
            <!--            <div class="postbox colorway-sites-box">
                            <div class="box-content">
                                <h2 class="cwy-normal-cusror">
                                    ...
                                    <span class="head-color"><?php //echo esc_html(apply_filters('colorway_sites_menu_page_title', __('Import Free Templates', 'colorway')));   ?></span>
                                </h2>
                                <div class="inside">
                                                            <p>
            <?php
            //esc_html_e('In need of free beautiful templates?', 'colorway');
            ?>
                                    </p>
                                    <p class="inside-desc">
            <?php
            ...
            //esc_html__('Download free ready to use templates in Colorway and once you choose your design then just click on it and your website will be ready. ', 'colorway'), self::$page_title, !empty($colorway_sites_doc_link) ? '<a href=' . esc_url($colorway_sites_doc_link) . ' target="_blank" rel="noopener">' . esc_html($colorway_sites_doc_link_text) . '</a>' :
...
//                            $class = 'active';
//                            $button_text = __('Download Templates Now »', 'colorway');
