...
class colorway_Customizer {

    public static function colorway_Register($wp_customize) {

        self::colorway_Sections($wp_customize);

        self::colorway_Controls($wp_customize);
    }

    public static function colorway_Sections($wp_customize) {
        ...
        $wp_customize->add_section('home_page_main_heading', array(
            ...
            'description' => __('Allows you to setup main heading for Colorway Theme.', 'colorway'), //Descriptive tooltip
            'panel' => 'cw_parent_setting_panel',
            'priority' => '12',
            'capability' => 'edit_theme_options'
                )
         ...
         */
        $wp_customize->add_section('excerpt_custom_length', array(
            'title' => __('Excerpt Length Setting', 'colorway'),
            'description' => __('<br><i>Allows you to Configure the excerpt length</i>', 'colorway'),
            'panel' => 'cw_parent_setting_panel',
            'priority' => '12',
            'capability' => 'edit_theme_options'
                )
        ...
        $wp_customize->add_section('background_image', array(
            ...
            'description' => __('Allows you to change Body Background Image for Colorway Theme. </br></br><b>Note:</b> Background image will be visible only in Boxed layout, Applying This will overright the Body Background Color property.', 'colorway'),
            'priority' => '4',
            'panel' => 'color_section'
        ));
        /**
         ...
         */
        $wp_customize->add_section('Read_more_button_stylings', array(
            'title' => __('Read More Button Color and Settings', 'colorway'),
            'description' => __('Allows you to change Button Colors for Colorway Theme.', 'colorway'),
            'priority' => '5',
            'panel' => 'color_section'
        ));
         ...
         */
        $wp_customize->add_section('typography_line_height', array(
            'title' => __('Line Height', 'colorway'),
            'description' => __("Allows you to set Line Height for Colorway Theme.", 'colorway'),
            'priority' => '3',
            'panel' => 'typography_section'
        ));
    }

    public static function colorway_Section_Content() {
        ...
        $section_content = array(
            ...
            'typography_font_weight' => array(
                ...
                'typography_fontweight_read_more_btn',
            ),
            'typography_font_size' => array(
                ...
                'typography_fontsize_read_more_btn'
            ),
...
//            ),
            ...
            'excerpt_custom_length' => array(
                'inkthemes_excerpt_length'
            ),
            ...
            'header_colors_section' => array(
                ...
                'sticky_menu_background_hover_color',
            ...
            'Read_more_button_stylings' => array(
                'read_btn_bg_color',
                'read_btn_txt_color',
                'read_btn_hover_bg_color',
                'read_btn_hover_txt_color',
                'read_more_btn_text',
                'read_more_btn_border',
                'read_btn_border_color',
                'read_btn_hover_border_color'
    ...
    public static function colorway_Settings() {
        /*
        ...
        // Typography Array
        $font_family = get_option('cw_google_fonts');
        ...
        $theme_settings = array(
            ...
            'colorway_sticky_header' => array(
                ...
                'description' => __('<b>Note:</b> Sticky header will work only in full width container layout.</br></br> After Configuring Sticky Option, you must publish the customizer once and configure the below settings', 'colorway'),
                'type' => 'option',
                'setting_type' => 'checkbox',
                'default' => false
            ),
            ...
            'colorway_slideimage1' => array(
                ...
                'description' => __('Choose Image for your Home page First Slider. Optimal Size: 1171px x 525px', 'colorway'),
                'type' => 'option',
                'setting_type' => 'image',
                'default' => ''
            ),
            ...
            'colorway_slideimage2' => array(
                ...
                'description' => __('Choose Image for your Home page Second Slider. Optimal Size: 1171px x 525px', 'colorway'),
                'type' => 'option',
                'setting_type' => 'image',
                'default' => ''
            ),
            ...
            'inkthemes_excerpt_length' => array(
                'id' => 'inkthemes_options[inkthemes_excerpt_length]',
                'label' => __('Excerpt Length', 'colorway'),
                'description' => __('Enter your Excerpt length', 'colorway'),
                'type' => 'option',
                'setting_type' => 'number',
                'default' => '20'
            ),
            ...
            'typography_read_more_btn' => array(
                'id' => 'inkthemes_options[typography_read_more_btn]',
                'label' => __('Read More Button Font Family', 'colorway'),
                'description' => __('Allows you to set Font Family For Read More Button.', 'colorway'),
                'type' => 'option',
                'setting_type' => 'select',
                'transport' => 'postMessage',
                'default' => '684',
            ...
            'typography_fontweight_read_more_btn' => array(
                'id' => 'inkthemes_options[typography_fontweight_read_more_btn]',
                'label' => __('Read More Button Font Weight', 'colorway'),
                'description' => __('Allows you to set Read More Button Font Weight.', 'colorway'),
                'type' => 'option',
                'setting_type' => 'select',
                'transport' => 'postMessage',
                'default' => '10',
            ...
            'typography_fontsize_read_more_btn' => array(
                'id' => 'inkthemes_options[typography_fontsize_read_more_btn]',
                'label' => __('Read More Button Font Size', 'colorway'),
                'description' => __('Allows you to set Read More Button Font Size.', 'colorway'),
                'type' => 'option',
                'setting_type' => 'select',
                'transport' => 'postMessage',
                'default' => '8',
            ...
            'sticky_menu_text_color' => array(
                'id' => 'inkthemes_options[sticky_menu_text_color]',
                'label' => __('Sticky Menu Link Color', 'colorway'),
                'description' => __('Set Sticky Menu link Color for Header.', 'colorway'),
                'type' => 'option',
                'setting_type' => 'alpha-color',
                'palette' => true,
                'default' => '',
            ),
            'sticky_menu_background_hover_color' => array(
                'id' => 'inkthemes_options[sticky_menu_background_hover_color]',
                'label' => __('Sticky Menu Hover Background Color', 'colorway'),
                'description' => __('Set Sticky Menu Hover background Color for Header.', 'colorway'),
                'type' => 'option',
                'setting_type' => 'alpha-color',
                'palette' => true,
                'default' => '',
            ),
            'sticky_menu_hover_link_color' => array(
                'id' => 'inkthemes_options[sticky_menu_hover_link_color]',
                'label' => __('Sticky Menu Hover Link Color', 'colorway'),
                'description' => __('Set Sticky Menu Hover Link Color for Header.', 'colorway'),
                'type' => 'option',
                'setting_type' => 'alpha-color',
                'palette' => true,
                'default' => '',
            ...
            'read_btn_bg_color' => array(
                'id' => 'inkthemes_options[read_btn_bg_color]',
                'label' => __('Button Background Color', 'colorway'),
                'description' => __('Set Button Background Color for Theme.', 'colorway'),
                'type' => 'option',
                'setting_type' => 'alpha-color',
                'palette' => true,
                'default' => '#eedec3',
            ),
            'read_btn_txt_color' => array(
                'id' => 'inkthemes_options[read_btn_txt_color]',
                'label' => __('Button Text Color', 'colorway'),
                'description' => __('Set Button Text Color for Theme.', 'colorway'),
                'type' => 'option',
                'setting_type' => 'alpha-color',
                'palette' => true,
                'default' => '#354053',
            ),
            'read_btn_hover_bg_color' => array(
                'id' => 'inkthemes_options[read_btn_hover_bg_color]',
                'label' => __('Button Hover Background Color', 'colorway'),
                'description' => __('Set Button Hover Background Color for Theme.', 'colorway'),
                'type' => 'option',
                'setting_type' => 'alpha-color',
                'palette' => true,
                'default' => '#ede3d5',
            ),
            'read_btn_hover_txt_color' => array(
                'id' => 'inkthemes_options[read_btn_hover_txt_color]',
                'label' => __('Button Hover Text Color', 'colorway'),
                'description' => __('Set Button Hover Text Color for Theme.', 'colorway'),
                'type' => 'option',
                'setting_type' => 'alpha-color',
                'palette' => true,
                'default' => '#0e88b5',
            ...
            'read_more_btn_text' => array(
                'id' => 'inkthemes_options[read_more_btn_text]',
                'label' => __('Read More Button Custom Text', 'colorway'),
                'description' => __('Here mention the text for Read Now Button', 'colorway'),
                'type' => 'option',
                'setting_type' => 'text',
                'default' => 'Read Now',
            ),
            'read_more_btn_border' => array(
                'id' => 'inkthemes_options[read_more_btn_border]',
                'label' => __('Read More Button-Border On/Off', 'colorway'),
                'description' => __('Turn on or off the Read More Button-Border as per your requirement.', 'colorway'),
                'type' => 'option',
                'setting_type' => 'radio',
                'default' => 'on',
                'choices' => array(
            ...
            'read_btn_border_color' => array(
                'id' => 'inkthemes_options[read_btn_border_color]',
                'label' => __('Read More Button Border Color', 'colorway'),
                'description' => __('Set Read More Button Border Color for Theme.', 'colorway'),
                'type' => 'option',
                'setting_type' => 'alpha-color',
                'palette' => true,
                'default' => '',
            ...
            'read_btn_hover_border_color' => array(
                'id' => 'inkthemes_options[read_btn_hover_border_color]',
                'label' => __('Read More Button Hover Border Color', 'colorway'),
                'description' => __('Set Read More Button Hover Border Color for Theme.', 'colorway'),
                'type' => 'option',
                'setting_type' => 'alpha-color',
                'palette' => true,
                'default' => '',
        ...
        foreach ($sections as $section_id => $section_content) {
            ...
            foreach ($section_content as $section_content_id) {
                ...
                switch ($settings[$section_content_id]['setting_type']) {
                    case 'image':
                        self::add_setting($wp_customize, $settings[$section_content_id]['id'], $settings[$section_content_id]['default'], $settings[$section_content_id]['type'], 'colorway_sanitize_url');
                    ...
                    case 'text':
                        self::add_setting($wp_customize, $settings[$section_content_id]['id'], $settings[$section_content_id]['default'], $settings[$section_content_id]['type'], 'colorway_sanitize_text');
                    ...
                    case 'textarea':
                        ...
                        self::add_setting($wp_customize, $settings[$section_content_id]['id'], $settings[$section_content_id]['default'], $settings[$section_content_id]['type'], 'colorway_sanitize_textarea');
                    ...
                    case 'alpha-color':
                        self::add_setting($wp_customize, $settings[$section_content_id]['id'], $settings[$section_content_id]['default'], $settings[$section_content_id]['type'], 'colorway_sanitize_color');
                        $wp_customize->add_control(new Colorway_Customize_Alpha_Color_Control(
                                $wp_customize, $settings[$section_content_id]['id'], array(
                            'label' => $settings[$section_content_id]['label'],
                            'description' => $settings[$section_content_id]['description'],
                            'section' => $section_id,
                    ...
                    case 'number':
                        ...
                        self::add_setting($wp_customize, $settings[$section_content_id]['id'], $settings[$section_content_id]['default'], $settings[$section_content_id]['type'], 'colorway_sanitize_number');
                    ...
                    case 'select':
                        ...
                        self::add_setting($wp_customize, $settings[$section_content_id]['id'], $settings[$section_content_id]['default'], $settings[$section_content_id]['type'], 'colorway_sanitize_select');
                    ...
                    case 'radio':
                        ...
                        self::add_setting($wp_customize, $settings[$section_content_id]['id'], $settings[$section_content_id]['default'], $settings[$section_content_id]['type'], 'colorway_sanitize_radio');
                    ...
                    case 'checkbox':
                        ...
                        self::add_setting($wp_customize, $settings[$section_content_id]['id'], $settings[$section_content_id]['default'], $settings[$section_content_id]['type'], 'colorway_sanitize_checkbox');
    ...
    public static function add_setting($wp_customize, $setting_id, $default, $type, $sanitize_callback) {
        $wp_customize->add_setting($setting_id, array(
            'default' => $default,
            'capability' => 'edit_theme_options',
            'sanitize_callback' => array('colorway_Customizer', $sanitize_callback),
            'type' => $type,
            'transport' => 'postMessage'
                )
        );
     ...
     * @package inkthemes
     */
    public static function colorway_sanitize_textarea($value) {
     ...
     * @package inkthemes
     */
    public static function colorway_sanitize_url($value) {
        $value = esc_url($value);
        return $value;
    }
     ...
     * @package inkthemes
     */
    public static function colorway_sanitize_text($value) {
     ...
     * @package inkthemes
     */
    public static function colorway_sanitize_email($value) {
        $value = sanitize_email($value);
        return $value;
    }

//    public static function colorway_sanitize_checkbox($checked) {
//        // Boolean check.
...
//    }
     ...
     * @package inkthemes
     */
    public static function colorway_sanitize_number($value) {
     ...
     * @package inkthemes
     */
    public static function colorway_sanitize_color($value) {
        return $value;
    }
     ...
     * @package inkthemes
     */
    public static function colorway_sanitize_select($value, $setting) {
        global $wp_customize;
     ...
     * @package inkthemes
     */
    public static function colorway_sanitize_radio($value, $setting) {
        global $wp_customize;
        $control = $wp_customize->get_control($setting->id);
        if (array_key_exists($value, $control->choices)) {
            return $value;
...
add_action('customize_register', array('colorway_Customizer', 'colorway_Register'));

function colorway_registers() {
...
add_action('customize_controls_enqueue_scripts', 'colorway_registers');
...
function colorway_customize_register($wp_customize) {
    ...
    class WP_Customize_Range_Control extends WP_Customize_Control {
        ...
        public function enqueue() {
            wp_enqueue_script('colorway-range-control', get_template_directory_uri() . '/functions/js/range-control.js', array('jquery'));
        }
...
//               'transport' => 'postMessage'
    ...
    $wp_customize->add_setting('title_font_size', array(
        ...
        'capability' => 'edit_theme_options',
        'type' => 'option',
        'sanitize_callback' => 'colorway_sanitize_floating_value',
        'transport' => 'postMessage'
            )
    );
    ...
    $wp_customize->add_setting('read_more_btn_rad', array(
        'default' => '0',
        'type' => 'option',
        'sanitize_callback' => 'colorway_sanitize_floating_value',
        'capability' => 'edit_theme_options',
    ...
    // Do stuff with $wp_customize, the WP_Customize_Manager object.
    $wp_customize->add_control(new WP_Customize_Range_Control($wp_customize, 'read_more_border_rad_option', array(
        'label' => __('Set Read More Button Radius', 'colorway'),
        'section' => 'Read_more_button_stylings',
        'settings' => 'read_more_btn_rad',
        'description' => __('Measurement is in pixel.', 'colorway'),
        'input_attrs' => array(
            'min' => 0,
            'max' => 29.99,
...
//        'transport' => 'postMessage'
    ...
    //line height
    $wp_customize->add_setting('para_line_height', array(
        'default' => '1.8',
        'type' => 'option',
        'sanitize_callback' => 'colorway_sanitize_floating_value',
        'capability' => 'edit_theme_options',
    ...
    // Do stuff with $wp_customize, the WP_Customize_Manager object.
    $wp_customize->add_control(new WP_Customize_Range_Control($wp_customize, 'para_line_height', array(
        'label' => __('Paragraph Line Height', 'colorway'),
        'section' => 'typography_line_height',
        'settings' => 'para_line_height',
        'description' => __('Measurement is in pixel.', 'colorway'),
        'priority' => '3',
        'input_attrs' => array(
            'min' => 1.0,
    ...
    if (colorway_get_option('colorway_sticky_header') == true) {
...
// Below code will add Content Width field in customizer
     ...
     * @package inkthemes
     */
    function colorway_sanitize_floating_value($value) {
        $value = preg_replace("/[^0-9+ ]/", "", $value);
        $temp = substr($value, 1);
        if ($temp != '') {
            $value = $value / 10;
